...
export default function Profile() {
  ...
  return (
    <View className="flex-1">
      {/* Header */}
      <View className="flex-row justify-between items-center py-3 px-5 border-b border-secondary">
        <View className="flex-row gap-4 items-center">
          ...
          <Pressable className="flex-row gap-2 items-center rounded-xl px-3 py-2 bg-secondary">
            <MaterialIcons
              name="edit"
              size={16}
              color={colorScheme === "dark" ? "white" : "black"}
            />
            <Text className="text-content opacity-80">Edit</Text>
          </Pressable>
        </View>
      </View>
      ...
      <ScrollView className="flex-1 bg-white">
        ...
        <View className="flex flex-col items-center bg-secondary-100 py-10">
          ...
          <Text className="text-3xl font-bold text-content pb-5">
            {profile?.full_name}
          </Text>
        </View>
        ...
        <View className="flex-1 flex flex-col justify-start w-full gap-5 p-5 rounded-xl border-t border-secondary bg-white">
          ...
          <View className="flex gap-5 justify-center items-center py-5">
            <SignOut />
          </View>
        </View>
      </ScrollView>
